...
*/
Vue.component("simple_footer_component_1721731385", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Create captivating cinematic experiences with Gone Maker. Bring your creative visions to life and craft unforgettable stories through seamless video editing and visual effects tools. Gone Maker empowers filmmakers, artists, and storytellers to unleash their imagination and leave a lasting impact.
                    </div>
                </div>
            </div>
        </footer> 
