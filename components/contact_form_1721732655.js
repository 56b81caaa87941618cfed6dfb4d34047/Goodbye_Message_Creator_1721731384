Vue.component('contact_form_1721732655', {
  template: `
    <main class="flex justify-center align-center p-10">
      <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
        <div>
          <h3 class="text-black font-semibold text-xl">Let's Bring Your Vision to Life</h3>
          <p class="mt-3 text-black w-fit">Get in touch to discuss how we can help make your film a reality.</p>
        </div>
        <form @submit.prevent class="space-y-5 mt-5">
          ...
          <div>
            <label class="font-medium text-black">Project Title</label>
